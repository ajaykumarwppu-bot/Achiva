...
(function () {
  ...
  /* AUTO-FIT helper : CanvasCards ka shared fit logic (text clip na ho) */
  ...
  function placePlan(plan) {
    ...
    /* title card (text ke hisaab se fitted) */
    ...
    plan.groups.forEach(function (g) {
      /* pehle har node ka fitted size nikaalo, phir unse grid banao
         (variable column-widths / row-heights → koi text clip nahi) */
