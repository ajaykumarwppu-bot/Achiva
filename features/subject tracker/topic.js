...
(function () {
  ...
  function buildMindMap(ch) {
    ...
    function placeKids(kids, parentCard, angStart, angSpan, depth) {
      ...
      kids.forEach(function (k) {
        ...
        var kc = mkCard(cx - 70, cy - 26, 140, 52,
    ...
    var root = mkCard(-100, -40, 200, 80, DEPTH_COLORS[0], ch.name);
  ...
  function render() {
    ...
    mmBtn.style.cssText = 'display:inline-flex;align-items:center;gap:7px;padding:9px 16px;' +
      'margin-left:8px;border-radius:99px;border:1px solid var(--s2);background:var(--chip-bg);' +
